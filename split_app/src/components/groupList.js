...
function GroupsList() {
    ...
    const getRequestedGroup = () => {
        ...
        if(userData && userData._id!=undefined && userData._id!=null){
            axios.get(`http://localhost:5000/getRequestedGroup/`+userData._id)
            .then(res => {
                const data = res.data;
                console.log(data)
    ...
    const acceptGrpReq = (grpId) => {
        ...
        if(grpId && grpId!==undefined && grpId!==null && userData){
            axios.get(`http://localhost:5000/acceptGrpReq/`+userData._id+`/`+grpId)
            .then(res => {
                const data = res.data;
                console.log(data)
                getRequestedGroup()
    ...
    const declineGrpReq = (grpId) => {
        ...
        // console.log('getLoginUser: '+userData._id)
        if(grpId && grpId!==undefined && grpId!==null && userData){
            axios.get(`http://localhost:5000/declineGrpReq/`+userData._id+`/`+grpId)
            .then(res => {
                const data = res.data;
                console.log(data)
                getRequestedGroup()
    ...
    const getExpenseCategory = ()=>{
        ...
        axios.get(`http://localhost:5000/getExpenseCategory`)
            .then(res => {
                const data = res.data;
                console.log(data)
    ...
    const saveExpense= (grpId)=>{
        ...
        if(userData && grpId && grpId!=null){
            axios.post(`http://localhost:5000/addGroupExpense`,expenseData)
            .then(res => {
                const data = res.data;
                console.log(data)
                setIsOpen(false)
